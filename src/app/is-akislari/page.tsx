  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
        ...
        <>
          <p className="text-sm text-slate-400 mb-4">{processes.length} iş akışı bulundu</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {processes.map((process, i) => {
              ...
              return (
                ...
                >
                  {thumb ? (
                    <div className="relative h-36 w-full overflow-hidden bg-white/10">
                      <Image
                        src={thumb}
                        alt={process.title}
                        fill
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-4">
                      {process.tags.slice(0, 3).map((pt) => (
                        <span key={pt.tag.id} className="badge bg-orange-500/10 text-orange-300 border border-orange-400/30 text-[10px]">
                          #{pt.tag.name}
                        </span>
                      ))}
                    </div>
